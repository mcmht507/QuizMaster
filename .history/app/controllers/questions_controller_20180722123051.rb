class QuestionsController < ApplicationController
  ...
  def index
    ...
    query = "SELECT questions.question_id question_id,questions.content content,questions.user_id user_id,questions.created_at created_at,questions.updated_at updated_at,answer.answer_id answer_id answer.is_correct is_correct,category.* FROM questions LEFT OUTER JOIN categories ON categories.category_id = questions.category_id LEFT OUTER JOIN answers ON answers.question_id = questions.question_id"
