...
Question.create({question_id:2,content:"test question",user_id:"test_admin",answer:"1",category_id:1})
Question.create({question_id:3,content:"test question",user_id:"test_admin",answer:"1",category_id:1})
