            ...
            {auth && (
              <div>
                ...
                >
                  {(() => {
                    if (role_type === "admin") {
                      return <MenuItem onClick={this.handleClose}>Profile</MenuItem><MenuItem onClick={this.handleClose}>My account</MenuItem>
                    } else {
                      return <MenuItem onClick={this.handleClose}>My account</MenuItem>
                    }
                  })()}
                </Menu>
              </div>
