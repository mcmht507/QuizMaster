      ...
      <div>
        ...
        <form onSubmit={handleSubmit(this.sendItems)} style={{ textAlign: 'center' }}>
          <div>
            ...
            // <textarea id= "#registWorkDetail" name="" id="" cols="30" rows="10"></textarea>
            <Editor
              apiKey="rjmdqspts9lz1p2mss4v5usuejb1svcgz9qnj9uli33ptnyn"
              init={{
                selector: "#registWorkDetail", // id="foo"の場所にTinyMCEを適用
                plugins:[
                ...
                toolbar: [
                  "undo redo | formatselect | table | bold italic strikethrough | alignleft aligncenter alignright | fontsizeselect forecolor link media image jbimages"
                ],
