...
import { AppBar, Toolbar, TextField,Avatar, Card, CardContent, Button, TextField } from 'material-ui'
      ...
      <div>
        ...
        <form onSubmit={handleSubmit(this.sendItems)} style={{ textAlign: 'center' }}>
          <div>
            ...
            <TextField name="password" type="password" component={FormTextField} label="pasword(※8 characters and alphameric characters)" />
            <br />
