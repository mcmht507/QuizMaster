...
const FormTextField = ({
  ...
  return (
    <TextField style={{ margin: 5, display: "inline-block" }} error={isError} label={label} helperText={isError ? error : null} {...input} type={type} />
  )
}
      ...
      <div>
        ...
        <Card style={{ padding: 10, }}>
          <form onSubmit={handleSubmit(this.sendItems)} style={{ textAlign: 'center' }}>
            <div>
              <Field name="firstname" type="text" component={FormTextField} label="username" style={{ display: "inline-block" }} />
              <Field name="firstname" type="text" component={FormTextField} label="username" />
