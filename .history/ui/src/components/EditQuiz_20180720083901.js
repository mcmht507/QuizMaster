...
const FormTextField = ({
  ...
  return (
    <TextField style={{ margin: 5, width: '90%' }} defaultValue={defaultValue} error={isError} label={label} helperText={isError ? error : null} {...input} type={type} />
  )
}
      ...
      <div>
        ...
        <form onSubmit={handleSubmit(this.sendItems)} style={{ width: '80%', margin: '0 auto', textAlign: 'center' }}>
          <div>
            ...
            <Field name="answer" type="text" defaultValue="aaaa" component={FormTextField}/>
