...
//   state => ({
//     initialValues: { answer: "aaaa" } // pull initial values from account reducer
//   }),
...
export default class EditQuiz extends React.Component {
  ...
  render() {
    ...
    if (question){
      ...
      this.props.initialize({ answer: question.content});
    }
    return (
      <div>
        ...
        <form onSubmit={handleSubmit(this.sendItems)} style={{ width: '80%', margin: '0 auto', textAlign: 'center' }}>
          <div>
            <CategoryList history={this.props.history} category_id={this.props.category_id} />
